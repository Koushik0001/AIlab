...
CSVData = open("A*start.csv")
start = np.loadtxt(CSVData, delimiter=" ")

CSVData2 = open("A*goal.csv")
...
class Process:
    ...
    def aStar(self):
        self.priorityQueue.put((self.currentState.pathCostFromStart, self.currentState))
        while(True):
            print("=============================================================================")
            ...
            if(len(successors) == 0):
                ...
                for successor in successors:
                    self.priorityQueue.put((successor.pathCostFromStart, successor))
