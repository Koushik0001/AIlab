...
class Process:
    ...
    """This function will return an unvisited successor of the self.currentState or if it does not have any unvisited node then it will return an empty list"""
    def explore(self):
